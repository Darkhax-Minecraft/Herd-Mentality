...
@Mod(HerdMentalityMod.MOD_ID)
public class HerdMentalityForge {
    
    private final Configuration configuration = new Configuration();
    public final TagKey<EntityType<?>> IGNORED_MOBS = TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation(HerdMentalityMod.MOD_ID, "ignored_mobs"));
    
    public HerdMentalityForge() {
